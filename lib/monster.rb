...
class Larves
  ...
  def to_json_larves
    ...
    puts "larves.json rewritten successufly"
  end
end
...
class Monstres_des_cavernes
  ...
  def to_json_monsters1
    ...
    puts "Monstres_des_cavernes.json rewritten successufly!"
  end
end
...
class Monstres_des_plaines
  ...
  def to_json_monsters2
    ...
    puts "Monstres_des_plaines_herbeuses.json rewritten successufly!"
  end
end
